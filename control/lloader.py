...
def becomeMaster():
    # verify if another Loader is running, kill it, and become the loader
    logging.info('verifying if other loader is running')
    try:
        loaderPid = '/home/pi/code/control/loader.pid'
...
if __name__ == "__main__":
    # DEBUG is on
    logging.basicConfig(filename='/home/pi/code/control/loader.log', level=logging.DEBUG, format='%(asctime)s %(message)s')
